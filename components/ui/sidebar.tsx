    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-white/90 backdrop-blur-xl border-r border-white/80 text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden shadow-[0_4px_30px_-4px_rgba(0,0,0,0.08)]"
          style={
            {
      ...
      >
        <div
          ...
          className={cn(
            ...
            variant === "floating" 
              ? "bg-white/80 backdrop-blur-xl border border-white/80 rounded-[24px] shadow-[0_8px_30px_-4px_rgba(0,0,0,0.08)]" 
              : "bg-white/90 backdrop-blur-xl border-r border-white/80 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.04)]"
          )}
        >
          {children}
        </div>
